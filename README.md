...
- [`em3rc0d-foundry/`](./em3rc0d-foundry/) — Foundry de productos y conocimiento: convierte evidencia, experiencia y activos reutilizables en ciclos de producto cada vez más baratos, verificables y acumulativos. **Actualmente en MK0**, destilando el corpus completo de Railly/skills sin promover sus decisiones automáticamente a canon EM3RC0D.
...
- [`research-corpora/railly-skills-2026-09-22/`](./research-corpora/railly-skills-2026-09-22/) — Snapshot exacto y atribuido de Railly/skills usado como fuente S-001 para EM3RC0D Foundry; el subtree upstream conserva el tree original y la licencia MIT.
