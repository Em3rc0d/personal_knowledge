...
- [`research-corpora/social-media-scraping-apis-2026-09-23/`](./research-corpora/social-media-scraping-apis-2026-09-23/) — Auditoría MK0 de un catálogo externo de APIs/scrapers sociales generado desde Apify Store: conserva snapshot, provenance comercial, límites de licencia/frescura y un gate discovery → docs → sandbox → compliance → promotion sin convertir listings en recomendaciones.
